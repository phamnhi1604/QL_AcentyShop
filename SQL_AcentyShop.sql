USE master
GO
DROP DATABASE QL_AcentyShop


CREATE DATABASE QL_AcentyShop
...
CREATE TRIGGER tg_CapNhatSoLuongNhapKho
...
GO
CREATE TRIGGER tg_CapNhatSoLuongXuatKhoHoaDon
ON ChiTietHoaDon
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
...
GO
CREATE TRIGGER tg_CapNhatSoLuongXuatKhoDonHang
ON ChiTietDonHang
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
...
SELECT dbo.TongTienDonHang(@IdDonhang) AS TongTien; */
...
SELECT dbo.TongTienDonHangCuaKhach(@IdDonhang, 10, 2023) AS TongTien;	*/
...
SELECT dbo.TinhDoanhThuChiNhanh(@IdChiNhanh,1 , 10, 2023) AS TongTien;	*/
go
